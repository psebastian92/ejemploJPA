    ...
    <div class="card shadow-lg bg-secondary p-4 rounded-4">
        ...
        <table class="table table-striped table-hover table-dark rounded-3 align-middle">
            ...
            <tbody>
                ...
                %>
                    <tr>
                        <td colspan="6" class="text-center text-muted">No hay canciones registradas.</td>
                    </tr>
                <%
                    }
                %>
        ...
        <div class="text-center mt-4">
            <a href="<%= request.getContextPath() %>/index.jsp" class="btn btn-outline-light me-2">🏠 Volver al inicio</a>
            <a href="<%= request.getContextPath() %>/vistas/crearCancion.jsp" class="btn btn-warning">➕ Agregar Canción</a>
        </div>
    </div>
</div>

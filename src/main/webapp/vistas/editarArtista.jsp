    ...
    <div class="card bg-secondary shadow-lg p-4 rounded-4">
        ...
        <form action="SvEditarArtista" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nombre" class="form-control" value="${art.nombre}" required>
            </div>

            <div class="mb-3">
                <label class="form-label">Género Musical</label>
                <input type="text" name="genero" class="form-control" value="${art.generoMusical}" required>
            </div>

            <div class="mb-3">
                <label class="form-label">Edad</label>
                <input type="number" name="edad" class="form-control" value="${art.edad}" required>
            </div>

...
public class Main {
	public static void main(String[] args) {
		Artista a1 = new Artista("Ciro Mart�nez", "Rock nacional", "argentino", 57);
		Artista a2 = new Artista("Pity Gonz�lez", "Rock nacional", "argentino", 64);
...
//		System.out.println(artEncontrado);
		...
		System.out.println("\n-------------------");
		try {
			System.out.println("Ingrese dato a eliminar seg�n ID: ");
...
//		System.out.println("2. G�nero Musical");
...
//			break;
//		case 2:
//			System.out.println("Nuevo g�nero musical: ");
